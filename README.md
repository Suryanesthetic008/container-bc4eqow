...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-bc4eqow.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-bc4eqow.containers.anotherwebservice.com/
...
```
git clone git@github.com:Suryanesthetic008/container-bc4eqow.git
cd container-bc4eqow
```
...
```
docker attach container-bc4eqow
```
